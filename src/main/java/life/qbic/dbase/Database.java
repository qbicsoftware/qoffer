...
//    String sql = "SELECT package_id, package_name FROM packages ORDER BY package_name";
    ...
    public void updatePackagePrice(String offer_id, String package_id, String packagePriceType, float packageDiscount) {
    ...
    public void updatePackageQuantityAndRecalculatePrice(String package_count, String offer_id, String package_id,
        ...
        updateOffersPackages(offer_id, package_id, package_count, updatedPackageAddOnPrice, packageDiscountFormatted);
    ...
    public void updateOffersPackages(String offer_id, String package_id, String package_count, BigDecimal updatedPackageAddOnPrice, String packageDiscountFormatted) {
    ...
    public void updateOffersPackages(String offer_id, String package_id, BigDecimal updatedPackageAddOnPrice) {
